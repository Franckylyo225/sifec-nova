      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-primary-foreground/90 animate-fade-in-up" style={{
            animationDelay: "0.2s"
          }}>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>Fondée en 2021, SIFEC est née d'une vision claire : révolutionner la manière dont les institutions et les personnalités publiques communiquent dans un monde en constante évolution.</p>
              <p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-start">
            ...
            <div className="relative h-[550px] rounded-2xl overflow-hidden shadow-2xl">
              <img src={teamPhoto} alt="L'équipe SIFEC" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/30 to-transparent" />
            </div>

            {/* Values Cards Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {values.map((value, index) => <Card key={index} className="border-border bg-card hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
